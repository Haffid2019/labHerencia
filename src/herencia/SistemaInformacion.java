...
do{
opcion = sistemaInformacion.leerDatoTipoEntero("Ingrese la opción 1 para procesar los datos del empleado,opcion 2 para procesar datos del estudiante  3 para salir: ");
if (opcion == 1)
{
...
manejadorEmpleado.imprimirReporteEstadoEmpleado();
    ...
    if(opcion == 2){
        ...
        est = est.datosDelEstudiante();
        est.imprimirCalificaciones();
    }
else
if (opcion == 3)
{
